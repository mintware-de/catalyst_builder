...
class Inject {
  /// If [tag] is set, the container will inject an array with all services with
  /// the given tag.
  /// If no services are tagged with the tag, an empty list will be injected.
  final Symbol? tag;

  /// The name of the bound parameter inside [AbstractServiceContainer.parameters].
  final String? parameter;

  /// Creates a new inject annotation.
  const Inject({this.tag, this.parameter});
}
